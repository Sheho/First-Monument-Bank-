        ...
        <div className="bg-slate-50 border border-slate-200 shadow-xl rounded-[2.5rem] p-6 md:p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
            ...
            <div className="space-y-6 text-left">
              ...
              <Link to="/register" className="inline-block bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-500/30 px-6 py-2.5 mt-4 rounded-xl font-semibold transition-all">
                Create an Account
              </Link>
            </div>
